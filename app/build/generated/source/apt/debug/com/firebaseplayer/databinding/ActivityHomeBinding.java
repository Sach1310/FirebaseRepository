...
public class ActivityHomeBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.home_profile_details, 7);
        sViewsWithIds.put(R.id.home_tv_user_name, 8);
        sViewsWithIds.put(R.id.rv_navigation_item, 9);
    }
    // views
    public final android.widget.ImageView homeIvDrawerMenu;
    public final android.widget.LinearLayout homeProfileDetails;
    public final android.widget.RelativeLayout homeProfileRl;
    public final com.firebaseplayer.widget.CustomTextView homeTvUserName;
    ...
    public ActivityHomeBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.homeProfileDetails = (android.widget.LinearLayout) bindings[7];
        this.homeProfileRl = (android.widget.RelativeLayout) bindings[6];
        this.homeTvUserName = (com.firebaseplayer.widget.CustomTextView) bindings[8];
        ...
        this.rvNavigationItem = (android.support.v7.widget.RecyclerView) bindings[9];
