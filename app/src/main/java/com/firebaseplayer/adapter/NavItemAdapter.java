...
//            holder.mBinding.llClick.setBackgroundColor(context.getResources().getColor(R.color.drawer_item));
            ...
            holder.mBinding.tvTextTitle.setTextColor(Color.WHITE);
            holder.mBinding.icIcon.setColorFilter(Color.argb(255, 255, 255, 255));
//            holder.mBinding.llClick.setBackgroundColor(context.getResources().getColor(R.color.drawer_item_deselected));
