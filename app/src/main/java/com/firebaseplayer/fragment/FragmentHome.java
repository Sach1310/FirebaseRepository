...
public class FragmentHome extends Fragment {
    ...
    private void init() {
        videoItems = new ArrayList<ModelVideoItem>();
        videoItems.add(new ModelVideoItem(R.drawable.image1, "AAA"));
        videoItems.add(new ModelVideoItem(R.drawable.image1, "BBB"));
        videoItems.add(new ModelVideoItem(R.drawable.image1, "CCC"));
        videoItems.add(new ModelVideoItem(R.drawable.image1, "DDD"));
